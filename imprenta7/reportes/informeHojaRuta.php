...
//Cabecera de página
	...
	/***************************FIN FACTURAS*************************************/	
			...
			if($cod_usuario_comision<>0){
				$this->Text($valorX+136,$valorY+53,"C3 :");
				$this->Text($valorX+144,$valorY+53,$usuarioComision);
			}
			...
			if($numeroFacturas>0){
				$this->Text($valorX+123,$valorY+63,"FACTURAS :");
				$this->Text($valorX+143,$valorY+63,"Nro. ".$facturas);
			}

			$this->SetFont('Arial','B',11);
			$this->SetTextColor(0,0,0);					
			$this->SetXY($valorX+16,$valorY+64);			
