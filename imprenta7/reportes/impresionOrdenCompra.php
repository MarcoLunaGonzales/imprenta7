...
//Cabecera de página
	...
	/***************************FIN FACTURAS*************************************/	
			...
			$this->SetFont('Arial','',9);			
			$this->Text($valorX+55,$valorY+38,"JENNISSE PUBLICIDAD ARTISTICA");	
			...
			$val_Y_cabecera=$val_Y_cabecera+5;
			$this->SetFont('Arial','',9);
			$this->Text($valorX+16,$val_Y_cabecera,"Sírvanse por este medio suministrarnos de los siguientes productos y/o servicios de acuerdo alos artes ya aprobados.");
