...
/**********************DATOS DE CABECERA*********************/
	...
	while ($dat=mysql_fetch_array($resp)){
		...
		$this->Text(26,258,"Validez de la oferta ".$dias_validez." días. - Forma de Pago:".$forma_pago);
		if($tiempo_entrega==0){
			$this->Text(26,262,"Tiempo de Entrega: A convenir");
		}else{
			$this->Text(26,262,"Tiempo de Entrega: ".$tiempo_entrega." días hábiles.");
		}
		...
		$this->Text(23,274,"- Agendas, Trípticos,");
