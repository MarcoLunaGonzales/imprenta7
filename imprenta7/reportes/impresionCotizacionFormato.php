	...
	while ($dat=mysql_fetch_array($resp)){
		...
		/**********************Fin Datos de Cliente******************************/	
			...
			$this->SetY(42);
			 ...
			 $this->ln(1);
 			 /*$this->Cell(0,3,"No. ".$nro_cotizacion."/".$gestion_nombre,0,1,'C',false);*/
			  $this->Cell(0,3,"No. ".$nro_cotizacion,0,1,'C',false);
			 $this->ln(1);
			 $this->Cell(0,3,"FECHA: ".$fechaCotizacionVectoAux[2]."/".$fechaCotizacionVectoAux[1]."/".$fechaCotizacionVectoAux[0],0,1,'C',false);	
 			 $this->Cell(0,3,'Página '.$this->PageNo().' de '.' {nb}',0,1,'R',false);
