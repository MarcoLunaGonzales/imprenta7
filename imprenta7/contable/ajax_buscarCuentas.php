...
require("conexion.inc");
		...
		$sql=" select count(*) ";
		$sql.=" from cuentas ";
		$sql.=" where cod_cuenta<>".$_GET['cuenta'];
...
?> 
		<tr bgcolor="#FFFFFF">	
			<td align="left"><?php echo $nro_cuenta;?></td>
				<td align="center"><strong><a href="javascript:enviarDatos('<?php echo $cod_cuenta;?>','<?php echo $nro_cuenta.' '.$desc_cuenta;?>','<?php echo $nro_cuenta;?>')"><?php echo $desc_cuenta;?></a></strong></td>
