...
<html>
<head>
<title>Anulacion de  Comprobante</title>
...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post" action="guardaAnularCbte.php">
<?php 	
...
<input type="hidden" name="cod_cbte" value="<?php echo $_GET['cod_cbte']?>" >
<h3 align="center" style="background:white;font-size: 12px;color:#E78611;font-weight:bold;">Anulacion de Comprobante <br>
  No. <?php echo $_GET['nro_cbte'];?></h3>
