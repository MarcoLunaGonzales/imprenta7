...
<form id="form1" name="form1" method="post" action="../reportes/rptFacturas.php" target="_blank" >
...
?>
<h3 align="center" style="background:#FFF;font-size: 14px;color: #E78611;font-weight:bold;">REPORTE DE FACTURAS</h3>
