...
function buscar(f){
	...
	ajax.open("GET","ajax_buscarClientes.php?nombre_clienteB="+document.getElementById("nombre_clienteB").value,true);		
...
function enviarDatos(cod_cliente,cliente){			
			window.close();
			window.opener.setCliente(cod_cliente,cliente);
}
</script>
...
?>
            ...
            <th>CLIENTE:</th>        
			<td>
				<input type='text' name='nombre_clienteB' id="nombre_clienteB" onKeyUp="buscar(this.form)" >
			</td>
