...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post" action="guardaAnularPagoProv.php">
<?php 	
...
<h3 align="center" style="background:white;font-size: 12px;color:#E78611;font-weight:bold;">Anulacion Pago a Proveedor <br>
  No. <?php echo $nro_pago_prov;?></h3>
