...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post" action="saveEditDescuentoOrdenTrabajo.php" name="form1">
...
?>
<h3 align="center" style="background:#FFF;font-size: 14px;color: #E78611;font-weight:bold;">EDICION DE DESCUENTO</h3>
		...
		<tr bgcolor="#FFFFFF">
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td>Monto </td>
      		<td>
			<?php
							echo $monto_orden_trabajo+$incremento_orden_trabajo." Bs.";
		 ...
		 <tr bgcolor="#FFFFFF">
			...
			<input type="text" name="descuento_orden_trabajo" id="descuento_orden_trabajo" value="<?php echo $descuento_orden_trabajo; ?>" class="textoform"></td>
    	</tr>      
		 <tr bgcolor="#FFFFFF">
     		<td>Obs. Descuento</td>
