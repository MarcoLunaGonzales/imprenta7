...
<!---Autor:Gabriela Quelali Si?ani
	02 de Julio de 2008
-->
<form   method="post" action="guardaRegistrarContactoProveedorAjax.php">
<input type="hidden" name="cod_proveedor" id="cod_proveedor" value="<?php echo $_GET['cod_proveedor'];?>">

<?php 	require("conexion.inc");

	$sql2="select nombre_proveedor from proveedores where cod_proveedor=".$_GET['cod_proveedor'];
...
?>
<h3 align="center" style="background:white;font-size: 14px;color:#d20000;font-weight:bold;">REGISTRO DE CONTACTO DE  PROVEEDOR <?PHP echo $nombre_proveedor;?></h3>
