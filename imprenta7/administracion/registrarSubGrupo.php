...
<html>
<head>
<title>Registro de SubGrupo</title>
...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form  name="form1" method="post" action="guardaRegistrarSubGrupo.php" accept-charset="UTF-8">
<?php 
...
<h3 align="center" style="background:white;font-size: 14px;color: #E78611;font-weight:bold;">Registro de SubGrupo </h3>
	...
	<table align="center"class="text" cellSpacing="1" cellPadding="4" width="60%" bgColor="#cccccc" border="0">
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td width="19%">SubGrupo</td>
      		<td colspan="2"><input type="text"  class="textoform" size="50" name="nombre_subgrupo" ></td>
    	</tr>
		 <tr bgcolor="#FFFFFF">
     		<td width="19%">Abreviatura</td>
      		<td colspan="2"><input type="text"  class="textoform" size="50" name="abrev_subgrupo" ></td>
    	</tr>        
