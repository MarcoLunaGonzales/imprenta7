...
$sql="select count(*) from usuarios where cod_usuario=".$_POST['cod_usuario'];
...
if($nroReg>0){
	$sql="delete from usuarios_modulos where cod_usuario='".$_POST['cod_usuario']."'"; 
	mysqli_query($enlaceCon,$sql);	
	...
	while($dat=mysqli_fetch_array($resp)){	
		...
		if($_POST["cod_modulo".$cod_modulo]){
			...
			$sql2.=" cod_usuario='".$_POST['cod_usuario']."'"; 
