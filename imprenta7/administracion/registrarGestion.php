		...
		<tbody>
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td>Gesti&oacute;n</td>
      		<td><input type="text"  class="textoform" size="20" name="gestion" id="gestion" ></td>
    	</tr>	
			<tr bgcolor="#FFFFFF">
     		<td>Gesti&oacute;n Formato Largo</td>
      		<td><input type="text"  class="textoform" size="20" name="gestion_nombre" id ="gestion_nombre" ></td>
    	</tr>			
		</tbody>
	</table>	
	<br>
