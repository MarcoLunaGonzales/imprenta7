...
<?php 	
	...
	$sql="select max(nro_nota_remision) from notas_remision where cod_gestion='".$cod_gestion."'";
...
<?php	
	...
	?>
	<h3 align="center" style="background:white;font-size: 14px;color: #d20000;font-weight:bold;">REGISTRO DE NOTA DE REMISION </h3>
