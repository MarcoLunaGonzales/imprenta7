...
<?php 
	...
	$sql.=" p.cod_estado_pago, ep.desc_estado_pago, p.fecha_anulacion, p.obs_anulacion, ";
	$sql.=" p.cod_usuario_anulacion, p.total_bs, p.fecha_registro ";
	...
	<?php			
       ...
       <tr bgcolor="#FFFFFF">
     		<td>Fecha Anulaci&oacute;n</td>
      		<td colspan="3"><?php echo strftime("%d/%m/%Y",strtotime($fecha_anulacion))." ". $nombres_usuario_anula[0].$ap_paterno_usuario_anula[0].$ap_materno_usuario_anula[0];?></td>
    	</tr>
