...
<title>Registro de Tipo de Cotizaci&oacute;n</title>
...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post" action="guardaRegistrarTipoCotizacion.php">
...
?>
<h3 align="center" style="background:white;font-size: 14px;color:#d20000;font-weight:bold;">Registro de Tipo de Cotizaci&oacute;n</h3>
	...
	<table align="center"class="text" cellSpacing="1" cellPadding="4" width="60%" bgColor="#cccccc" border="0">
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td>Tipo de Cotizaci&oacute;n</td>
      		<td><input type="text"  class="textoform" size="55" name="nombre_tipo_cotizacion" ></td>
    	</tr>		
		 <tr bgcolor="#FFFFFF">
   			<td>Observaciones</td>
      		<td ><textarea cols="55" name="obs_tipo_cotizacion" rows="3" class="textoform"> </textarea></td>
    	</tr>		
		 <tr bgcolor="#FFFFFF">
   			<td>Estado</td>
