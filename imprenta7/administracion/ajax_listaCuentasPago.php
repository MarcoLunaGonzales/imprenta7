...
function buscar(f){
	...
	ajax=nuevoAjax();
//alert("aquii="+document.getElementById("numero").value);
	ajax.open("GET","ajax_buscarCuentasPago?numero="+document.getElementById("numero").value+"&numero_cuentaB="+document.getElementById("numero_cuentaB").value,true);		
...
function enviarDatos(cod_cuenta,cuentaDesc,numero){			
			window.close();
			window.opener.setCuentas(cod_cuenta,cuentaDesc,numero);
}
</script>
...
<input type="hidden" name="cuenta" id="numero"  value="<?php echo $_GET['numero'];?>">
