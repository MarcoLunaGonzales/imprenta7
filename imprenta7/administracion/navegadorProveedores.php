...
<td colspan="3"><input type="text" name="clienteContactoB" id="clienteContactoB" size="60" class="textoform" value="<?php echo $clienteContactoB;?>" onkeyup="buscar()" ></td>
</tr>
</table>
<table border="0" align="center" width="89%">
<tr><td align="right">
<div align="right"><a href="registrarCliente.php"><img src="img/clientes_nuevo.gif" border="0" width="25" height="25">[Click Nuevo Cliente]</a></div>
</td>
</tr>
</table>
