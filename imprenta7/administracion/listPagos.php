...
<h3 align="center" style="background:#FFF;font-size: 14px;color: #E78611;font-weight:bold;">LISTADA DE PAGOS
...
?> 
		<tr bgcolor="#FFFFFF">	
    		<td align="right"><a href="../reportes/impresionPago.php?cod_pago=<?php echo $cod_pago;?>" target="_blank"><?php echo $nro_pago."/".$gestion;?></a></td>
