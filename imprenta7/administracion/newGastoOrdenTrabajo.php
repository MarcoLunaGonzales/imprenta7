...
?>
<h3 align="center" style="background:#FFF;font-size: 14px;color: #E78611;font-weight:bold;">COSTO DE ORDEN DE TRABAJO<?php echo " Nro. ".$nro_orden_trabajo."/".$gestion." (".$numero_orden_trabajo.")"; ?></br> CLIENTE: <?php echo $nombre_cliente;
...
(dd/mm/aaaa)</td>
         ...
         <select class="textoform" name="cod_proveedor" id="cod_proveedor" onChange="listaContactosProveedor(this.form)">
            <?php
            	...
            	$sql2.=" from proveedores where cod_proveedor=18 ";
