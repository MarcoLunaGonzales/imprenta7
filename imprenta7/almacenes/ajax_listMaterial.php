...
function buscar(f){
		...
		ajax.open("GET","ajax_buscarMaterial.php?cod_grupo="+document.getElementById("cod_grupo").value+"&cod_subgrupo="+document.getElementById("cod_subgrupo").value+"&nombreMaterialB="+document.getElementById("nombreMaterialB").value+"&numMaterial="+document.getElementById("numMaterial").value,true);		
...
function enviarDatos(numMaterial,cod_material,desc_completa_material){			
			window.close();
			//alert("datos="+numMaterial+" "+cod_material+" "+desc_completa_material);
			window.opener.setMateriales(numMaterial,cod_material,desc_completa_material);
}
</script>
