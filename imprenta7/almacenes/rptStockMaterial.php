...
function buscar(f){
		...
		ajax.open("GET","rptStockMaterial_buscar?cod_grupo="+document.getElementById("cod_grupo").value+"&cod_subgrupo="+document.getElementById("cod_subgrupo").value+"&nombreMaterialB="+document.getElementById("nombreMaterialB").value,true);		
