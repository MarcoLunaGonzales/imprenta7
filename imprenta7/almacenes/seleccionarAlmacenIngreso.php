...
{	
	...
	else
	{
		...
		{
			window.location="registrarIngresoExterno.php?cod_almacen="+cod_registro;
		}
	}
}		
</script>
...
echo "variable Global".$_COOKIE['usuario_global'];

?>
<h3 align="center" style="background:white;font-size: 14px;color:#E78611;font-weight:bold;">Seleccionar Almacen para Ingresos</h3>
