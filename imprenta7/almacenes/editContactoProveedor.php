...
<html>
<head>
<title>Edicion Contacto-Proveedor</title>
...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post" action="saveEditContactoProveedor.php">
...
<?php 	require("conexion.inc");
	...
	$sql=" select  cod_proveedor, nombre_contacto, ap_paterno_contacto, ap_materno_contacto,";
...
?>
<input type="hidden" name="cod_proveedor" id="cod_cliente" value="<?php echo $cod_proveedor;?>">
<h3 align="center" style="background:white;font-size: 14px;color:#E78611;font-weight:bold;">EDICION DE DATOS DE CONTACTO <br/> PROVEEDOR:<?PHP echo $nombre_proveedor;?></h3>
