...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post" action="editDescuentoOrdenTrabajo.php" name="form1">
...
?>
<h3 align="center" style="background:#FFF;font-size: 14px;color: #E78611;font-weight:bold;">DESCUENTO</h3>
		...
		<tr bgcolor="#FFFFFF">
     		...
     		<td>Monto de Descuento </td>
      		<td><?php 
				if($descuento_orden_trabajo<>''){
					echo $descuento_orden_trabajo." Bs.";
				}else{
				echo "0 Bs.";
				}
			?>
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td>Fecha de Descuento </td>
      		<td><?php if($descuento_fecha<>""){
				 echo strftime("%d/%m/%Y",strtotime($descuento_fecha));
			}
				 ?></td>
    	</tr>        
		 <tr bgcolor="#FFFFFF">
     		<td>Obs. Descuento</td>
      		<td><?php echo $descuento_obs;?></td>
    	</tr>
