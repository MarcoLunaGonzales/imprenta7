...
<body bgcolor="#F7F5F3">
<h3 align="center" style="background:#F7F5F3;font-size: 14px;color: #E78611;font-weight:bold;">REPORTE DE EXISTENCIAS CON STOCK</h3>
...
?>
    <tr height="20px" align="center"  class="titulo_tabla">
	  <td colspan="8"><?php echo strtoupper($nombre_grupo);?></td>									
	</tr>        
<?php	
	...
	?>
    	    <tr height="20px" align="left"  class="titulo_tabla">
			  <td colspan="8"><?php echo strtoupper($nombre_subgrupo);?></td>									
			</tr> 
    	    <tr height="20px" align="center"  class="titulo_tabla">
			  <td>ID ANTIGUO</td>
              <td>ID ACTUAL</td>
    ...
    <?php
			...
			////////////LISTADO DE MATERIALES////////////
				...
				while($datMateriales=mysql_fetch_array($respMateriales)){
					...
					//////////////FIN COSTO MATERIAL////////////////////////
	if(cantActualMaterial($cod_material,$cod_almacen)>0){					
	...
	?>
		...
		echo $abrev_grupo." ".$abrev_subgrupo." ".$varAux.$cod_material;?></td>
            ...
            <td align="right"><?php echo number_format(cantActualMaterial($cod_material,$cod_almacen),2);?></td>
	...
	?>
    <tr bgcolor="#FFFFFF">
    	<td align="right"  colspan="6"><strong><?php echo "TOTAL ".strtoupper($nombre_subgrupo);?></strong></td>
	    <td align="right"><?php echo $costoTotalSubGrupo;?></td>
        <td align="right">&nbsp;</td>
    </tr>
    <?php
	...
	?>
        <tr bgcolor="#FFFFFF">
    	<td align="right"  colspan="6"><strong><?php echo "TOTAL GRUPO: ".strtoupper($nombre_grupo);?></strong></td>
	    <td align="right"><?php echo $totalGrupo;?></td>
        <td align="right">&nbsp;</td>
    </tr>
	<?php					
	}
