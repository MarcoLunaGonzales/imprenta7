...
?>
<input type="hidden" name="cod_proveedor" value="<?php echo $_GET['cod_proveedor'];?>">
<h3 align="center" style="background:white;font-size: 14px;color:#E78611;font-weight:bold;">DATOS DE PROVEEDOR </h3>
