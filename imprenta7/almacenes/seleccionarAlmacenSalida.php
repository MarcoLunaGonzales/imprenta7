...
{	
	...
	else
	{
		...
		{
			window.location="registrarSalida.php?cod_almacen="+cod_registro;
		}
	}
}		
</script>
...
<h3 align="center" style="background:white;font-size: 14px;color:#E78611;font-weight:bold;">Seleccionar Almacen para Salidas </h3>
