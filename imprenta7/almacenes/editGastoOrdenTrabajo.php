...
?>
<h3 align="center" style="background:#F7F5F3;font-size: 14px;color: #E78611;font-weight:bold;">GASTOS DE ORDEN DE TRABAJO<?php echo " Nro. ".$nro_orden_trabajo."/".$gestion." (".$numero_orden_trabajo.")"; ?></br> CLIENTE: <?php echo $nombre_cliente;
...
<tr bgcolor="#FFFFFF">
  ...
  <td><div id="div_contactoProveedor"><select name="cod_contacto" id="cod_contacto" class="textoform" >
