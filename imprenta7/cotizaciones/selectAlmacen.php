...
<h3 align="center" style="background:#FFF;font-size: 14px;color: #E78611;font-weight:bold;">SELECCIONAR ALMACEN</h3>
	...
	include("funciones.php");			
			...
			?>
            			 <tr bgcolor="#FFFFFF">
			      		...
			      		<td align="center"><a href="rptStockMaterial.php?cod_almacen_global=<?php echo $cod_almacen; ?>"  ><h3 align="center" style="background:#FFF;font-size: 12px;color: #666600;font-weight:bold;"><?php echo $nombre_almacen;?></h3></a></td>
			    	</tr>	
            <?php				
					}
