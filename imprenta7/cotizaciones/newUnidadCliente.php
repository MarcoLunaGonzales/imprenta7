...
<?php 	require("conexion.inc");
	...
	$sql2="select nombre_cliente,direccion_cliente from clientes where cod_cliente=".$_POST['cod_cliente'];
...
<h3 align="center" style="background:white;font-size: 14px;color:#E78611;font-weight:bold;">REGISTRO DE UNIDAD<br/> CLIENTE:<?PHP echo $nombre_cliente;?></h3>
	...
	<table align="center"class="text" cellSpacing="1" cellPadding="4" width="60%" bgColor="#cccccc" border="0">
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td>Direccion</td>
      		<td><input type="text"  class="textoform" size="55" value="<?php echo $direccion_cliente;?>" name="direccion_unidad" id="direccion_unidad" ></td>
    	</tr>			
		<tr bgcolor="#FFFFFF">
     		<td>Telefono</td>
