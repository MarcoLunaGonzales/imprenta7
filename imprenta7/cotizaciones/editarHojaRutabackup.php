...
function guardar(f)
{
	...
	alert("vectorDiseno="+vectorDiseno);
	alert("vectorDisenoAprobadoPor="+vectorDisenoAprobadoPor);
	alert("vectorPlacas="+vectorPlacas);
	alert("vectorCantidad="+vectorCantidad);
...
<?php	
    ...
    <table  cellSpacing="1" cellPadding="2" width="90%" bgColor="#cccccc" border="0" id="tabla" align="center">
		...
		<tr bgcolor="#FFFFFF">
     		<td>Observaciones</td>
     		<td colspan="5"><textarea name="obs_hoja_ruta" cols="80" rows="1"><?php echo $obs_hoja_ruta;?></textarea></td>
		</tr>	
		<tr bgcolor="#FFFFFF">
     		<td>Factura</td>
     		<td colspan="5">Si
	...
	<?php
		...
		<tr bgcolor="#FFFFFF">		
				...
				<td colspan="2">Inventa
				  ...
				  &nbsp;&nbsp;Cliente<input type="radio" name="diseno<?php echo $cod_cotizaciondetalle;?>" <?php if($diseno==2){ echo "checked='checked'";}?>>
		<tr bgcolor="#FFFFFF">		
				<td align="right">Aprobado por:</td>
				<td colspan="2">Inventa <input name="aprobado_por<?php echo $cod_cotizaciondetalle;?>" type="radio" value="1" <?php if($diseno_aprobacion==1){ echo "checked='checked'";}?>>
		...
		<tr bgcolor="#FFFFFF">		
			...
			<?php
				...
				while($dat3=mysqli_fetch_array($resp3))
				{
					...
					$sql7="select count(*) asc sw_maquina ";
...
<div align="center">
	...
	<input type="button"  class="boton" name="cancelar" value="Cancelar" onclick="cancelar(this.form)">
</div>
