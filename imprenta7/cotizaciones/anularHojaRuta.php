...
<?php
	...
	<h3 align="center" style="background:white;font-size: 12px;color: #d20000;font-weight:bold;">ANULAR HOJA DE RUTA</h3>
		<h3 align="center" style="background:white;font-size: 12px;color: #d20000;font-weight:bold;">No. <?php echo $nro_hoja_ruta."/".$gestionNombreHR;?><br><?php echo $fecha_hoja_ruta;?></h3>
	...
	<table  cellSpacing="1" cellPadding="2" width="70%" bgColor="#cccccc" border="0" id="tabla" align="center">
		...
		<tr bgcolor="#FFFFFF">
			...
			<td rowspan="2" align="center"><?php echo $nro_cotizacion;?>/<?php echo $gestion_nombre;?></td>
