...
$obs_nota_remision = $_POST['obs_nota_remision'];
...
$fecha_nota_remision=date('Y-m-d H:i:s', time());

$sql=" insert into notas_remision set  ";
$sql.=" cod_nota_remision='".$cod_nota_remision."',";
$sql.=" cod_gestion='".$cod_gestion."',";
$sql.=" nro_nota_remision='".$nro_nota_remision."',";
$sql.=" fecha_nota_remision='".$fecha_nota_remision."',";
...
$sql.=" cod_estado_nota_remision=1, ";
