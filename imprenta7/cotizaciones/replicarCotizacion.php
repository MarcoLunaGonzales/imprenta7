...
//					descCaracArray[k]=celda_2.value;
	...
	if(msj){
		f.action="updateReplicarCotizacion.php";
	    f.submit();	
	}
}
function sumar(obj){
...
<?php 	
	...
	$sql.=" incremento_cotizacion,incremento_fecha,incremento_obs,";
	$sql.=" descuento_cotizacion,descuento_fecha,descuento_obs ";
	...
	$dat_00=mysqli_fetch_array($resp_00);
		...
		$incremento_cotizacion=$dat_00[20];
		$incremento_fecha=$dat_00[21];
		$incremento_obs=$dat_00[22];
		$descuento_cotizacion=$dat_00[23];
		$descuento_fecha=$dat_00[24];
		$descuento_obs=$dat_00[25];
...
?>
<h3 align="center" style="background:white;font-size: 14px;color: #E78611;font-weight:bold;">REGISTRO DE NUEVA  COTIZACI&Oacute;N</h3>
<h3 align="center" style="background:white;font-size: 14px;color: #E78611;font-weight:bold;">No. <?php echo $nro_cotizacion;?>/<?php echo $gestion_nombre;?></h3>
...
<td style="background:#FFF;font-size: 13px;color: #FF0000;font-weight:bold;">Incremento:</td>
<td style="background:#FFF;font-size: 13px;color: #000000;font-weight:bold;"><?php  echo $incremento_cotizacion;?></td>
<td style="background:#FFF;font-size: 13px;color: #FF0000;font-weight:bold;">Obs:</td>
<td style="background:#FFF;font-size: 13px;color: #000000;font-weight:bold;"><?php  echo $incremento_obs;?></td>
</tr>
<?php
}
?>
...
<td style="background:#FFF;font-size: 13px;color: #FF0000;font-weight:bold;">Descuento:</td>
<td style="background:#FFF;font-size: 13px;color: #000000;font-weight:bold;"><?php echo $descuento_cotizacion;?></td>
<td style="background:#FFF;font-size: 13px;color: #FF0000;font-weight:bold;">Obs:</td>
<td style="background:#FFF;font-size: 13px;color: #000000;font-weight:bold;"><?php  echo $descuento_obs;?></td>
</tr>
<?php
}
?>
	...
	<center>
		...
		&nbsp;&nbsp;<select class="textoform" id="cod_item<?php echo $cont;?>" onChange="javascript:items_caracteristicas(this.form,'<?php echo $cont?>');">
					...
					<?php
						...
						$sql3.=" where cod_compitem='".$codCompItem."' order  by orden asc ";
						$resp3= mysqli_query($enlaceCon,$sql3);
						while($dat3=mysqli_fetch_array($resp3)){
							$codCarac=$dat3[0];
