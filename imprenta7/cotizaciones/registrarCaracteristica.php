...
<title>Registro de Caracteristicas</title>
...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post" action="guardaRegistrarCaracteristica.php">
...
?>
<h3 align="center" style="background:white;font-size: 14px;color:#d20000;font-weight:bold;">Registro de Caracteristica </h3>
	...
	<table align="center"class="text" cellSpacing="1" cellPadding="4" width="60%" bgColor="#cccccc" border="0">
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td>Caracteristica</td>
      		<td><input type="text"  class="textoform" size="55" name="desc_carac" ></td>
    	</tr>				
		 <tr bgcolor="#FFFFFF">
   			<td>Estado</td>
