...
<html>
<head>
<title>Eliminación de Grados Academico</title>
...
<script language='Javascript'>
	...
	function cancelar(f){
					window.location="navegadorGradoAcademico.php";
	}
</script>
...
02 de Julio de 2008
-->
<form name="form1" method="post" action="eliminarGradoAcademico.php">
<?php 
...
<input type="hidden" name="datos" value="<?php echo $datos; ?>">
	<h3 align="center" style="background:white;font-size: 14px;color: #d20000;font-weight:bold;">Confirmacion de Eliminacion de Grados Academicos </h3>
