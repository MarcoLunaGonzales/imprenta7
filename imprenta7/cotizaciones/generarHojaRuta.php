...
function guardar(f)
{
	...
	//alert("Observaciones="+f.vectorObservaciones.value);
...
<?php	
		...
		/********************DATOS COTIZACION********************/
			...
			$sql2.=" cod_unidad, cod_contacto, dias_validez, cod_usuario_comision";
			...
			while($dat2=mysql_fetch_array($resp2)){
				...
				$dias_validez=$dat2['dias_validez'];	
				$codusuariocomision=$dat2['cod_usuario_comision'];	
			}
			/*******************CLIENTE*********************/	
	...
	?>
	<h3 align="center" style="background:white;font-size: 14px;color: #E78611;font-weight:bold;">GENERAR HOJA DE RUTA</h3>
	<h3 align="center" style="background:white;font-size: 12px;color: #E78611;font-weight:bold;">No. <?php echo $nro_hoja_ruta."/".$gestion;?></h3>
    <table  cellSpacing="1" cellPadding="2" width="90%" bgColor="#cccccc" border="0" id="tabla" align="center">
		...
		<tr bgcolor="#FFFFFF">
     		<th align="left">Cotizacion</th>
     		<td  >No. <?php echo $nro_cotizacion;?>/<?php echo $gestion;?></td>
			<th align="left">Fecha de Cotizacion</th>
     		<td colspan="3"><?php echo strftime("%d/%m/%Y",strtotime($fecha_cotizacion)); ?></td>
		</tr>		
		<tr bgcolor="#FFFFFF">
			...
			<td  align="left"><?php echo $telefono_cliente." ".$celular_cliente;?></td>            
		</tr>	
        <?php if($nombre_unidad<>""){?>
        <tr bgcolor="#FFFFFF">
     		<th align="left">&nbsp;</th>
			<td  align="left"><strong>Unidad:&nbsp;</strong><?php echo $nombre_unidad;?></td>
     		<th align="left">Telefono</th>
			<td  align="left" colspan="3">&nbsp;</td>            
		</tr>	
        <?php }?>        
        <?php if($nombre_contacto_cliente<>""){?>
        <tr bgcolor="#FFFFFF">
     		<th align="left">&nbsp;</th>
			<td  align="left"><strong>Contacto:&nbsp;</strong><?php echo $nombre_contacto_cliente;?></td>
     		<th align="left">Telefono</th>
			<td  align="left" colspan="3"><?php echo $telefono_contacto." ".$celular_contacto;?></td>            
		</tr>	
        <?php }?>
		<tr bgcolor="#FFFFFF">
	...
	<?php
		...
		<tr bgcolor="#FFFFFF">		
				...
				<td colspan="2">Imprenta <input name="aprobado_por<?php echo $cod_cotizaciondetalle;?>" type="radio" value="1" checked="checked">
