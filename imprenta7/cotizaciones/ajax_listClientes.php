...
function enviarDatos(cod_cliente,nombre_cliente,usuario_comision){			
			window.close();
			window.opener.setClientes(cod_cliente,nombre_cliente,usuario_comision);
}
</script>
...
<td ><strong>Clientes con Comision</strong></td>
</tr>
</table>
