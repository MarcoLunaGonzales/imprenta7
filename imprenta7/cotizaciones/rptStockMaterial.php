...
function buscar(f){
		...
		ajax.open("GET","rptStockMaterial_buscar?cod_grupo="+document.getElementById("cod_grupo").value+"&cod_subgrupo="+document.getElementById("cod_subgrupo").value+"&nombreMaterialB="+document.getElementById("nombreMaterialB").value+"&cod_almacen_global="+document.getElementById("cod_almacen_global").value,true);		
...
<input type="hidden" name="cod_almacen_global" id="cod_almacen_global" value="<?php echo $_GET['cod_almacen_global'];?>">
