...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post"  name="form1" id="form1" action="saveEditOrdenTrabajo.php">
<?php ?>
<input type="hidden" id="cod_orden_trabajo" name="cod_orden_trabajo" value="<?php echo $_GET['cod_orden_trabajo']; ?>">
<?php 
	$sql=" select cod_est_ot, nro_orden_trabajo, cod_gestion, ";
		...
		<tbody>
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td>Numero Interno</td>
      		<td>
            <input type="text" name="numero_orden_trabajo" id="numero_orden_trabajo" value="<?php echo $numero_orden_trabajo;?>" class="textoform">
</td>
    	</tr>
		 <tr bgcolor="#FFFFFF">
			...
			?>
            <input type="text" name="fecha_orden_trabajo" id="fecha_orden_trabajo" class="textoform" value="<?php echo $dOT."/".$mOT."/".$aOT;?>">
(dd/mm/aaaa) </td>
    	</tr>        
		 <tr bgcolor="#FFFFFF">
     		<td>Cliente</td>
	...
	<select name="cod_contacto" id="cod_contacto" class="textoform" >
        ...
        <td><select name="cod_tipo_pago" id="cod_tipo_pago" class="textoform" >
				<?php
				 ...
				 ?>
				 			<option value="<?php echo $cod_tipo_pago;?>" <?php if($cod_tipo_pago==$codtipopago){?> selected="true" <?php }?>>
