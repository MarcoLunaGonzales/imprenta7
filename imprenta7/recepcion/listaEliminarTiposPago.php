...
<html>
<head>
<title>Eliminación de Tipos de Pago</title>
...
<script language='Javascript'>
	...
	function cancelar(f){
					window.location="navegadorTiposPago.php";
	}
</script>
...
02 de Julio de 2008
-->
<form name="form1" method="post" action="eliminarTiposPago.php">
<?php 
...
<input type="hidden" name="datos" value="<?php echo $datos; ?>">
	<h3 align="center" style="background:white;font-size: 14px;color: #d20000;font-weight:bold;">Confirmacion de Eliminacion de Pago </h3>
    ...
    <?php
		...
		for($i=0;$i<$n;$i++){	
				...
				if($sw==0){
					/****************************/
						if($datosEliminar<>""){
							$datosEliminar=$datosEliminar.",".$cod_tipo_pago;
						}else{
							$datosEliminar=$cod_tipo_pago;
						}
					/****************************/
				}else{
					/***************************/
						if($datosNoEliminar<>""){
								$datosNoEliminar=$datosNoEliminar.",".$cod_tipo_pago;
						}else{
							$datosNoEliminar=$cod_tipo_pago;
						}
					/**************************/		
				}
...
<h3 align="center" style="background:white;font-size: 11px;color:#d20000;">Registros que no pueden ser Elimandos</h3>
	<table width="80%" align="center" cellpadding="1" cellspacing="1" bgColor="#cccccc">
		...
		<?php
			...
			for($j=0;$j<$num;$j++){	
				$cod_tipo_pago=$vectordatosNoEliminar[$j];
...
<h3 align="center" style="background:white;font-size: 11px;color:#d20000;">Registros que pueden ser Elimandos</h3>
	<table width="80%" align="center" cellpadding="1" cellspacing="1" bgColor="#cccccc">
		...
		<?php
			...
			for($j=0;$j<$num;$j++){	
				$cod_tipo_pago=$vectordatosEliminar[$j];
