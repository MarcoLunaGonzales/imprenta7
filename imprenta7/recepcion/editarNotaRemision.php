...
<?php	
	...
	?>
	<h3 align="center" style="background:white;font-size: 14px;color: #d20000;font-weight:bold;">EDICION DE NOTA DE REMISION </h3>
	<h3 align="center" style="background:white;font-size: 10px;color: #d20000;font-weight:bold;">No. <?php echo $nro_nota_remision."/".$gestionNotaRemision;?><?php echo "<br> Fecha:".$fecha_nota_remision;?></h3>
