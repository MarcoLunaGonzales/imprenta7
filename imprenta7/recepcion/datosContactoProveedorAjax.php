...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post" action="guardadatosContactoProveedorAjax.php">
...
<h3 align="center" style="background:white;font-size: 14px;color:#d20000;font-weight:bold;">DATOS DE CONTACTO DE PROVEEDOR<?PHP echo strtoupper($nombre_proveedor);?></h3>
