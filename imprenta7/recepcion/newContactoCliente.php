...
<script language='Javascript'>
	...
	{	
		...
		window.location="listContactosClientes.php?cod_cliente="+f.cod_cliente.value+"&clienteContactoB="+f.nombre_cliente.value;
	}
</script>
...
<!---Autor:Gabriela Quelali Si?ani
	02 de Julio de 2008
-->
<form   method="post" action="saveContactoCliente.php">
...
<h3 align="center" style="background:white;font-size: 14px;color:#E78611;font-weight:bold;">REGISTRO DE CONTACTO <br/> CLIENTE:<?PHP echo $nombre_cliente;?></h3>
