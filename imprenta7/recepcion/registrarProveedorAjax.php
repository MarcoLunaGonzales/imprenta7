...
<h3 align="center" style="background:white;font-size: 14px;color:#E78611;font-weight:bold;">Registro de Proveedor </h3>
	...
	<tbody>
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td>Contacto 1</td>
      		<td><input type="text"  class="textoform" size="55" name="contacto1_proveedor" ></td>
    	</tr>			
		 <tr bgcolor="#FFFFFF">
     		<td>Celular Contacto 1</td>
      		<td><input type="text"  class="textoform" size="55" name="cel_contacto1_proveedor" ></td>
    	</tr>	
		 <tr bgcolor="#FFFFFF">
     		<td>Contacto 2</td>
      		<td><input type="text"  class="textoform" size="55" name="contacto2_proveedor" ></td>
    	</tr>			
		 <tr bgcolor="#FFFFFF">
     		<td>Celular Contacto 2</td>
      		<td><input type="text"  class="textoform" size="55" name="cel_contacto2_proveedor" ></td>
    	</tr>			 				
		 <tr bgcolor="#FFFFFF">
   			<td>Estado</td>
