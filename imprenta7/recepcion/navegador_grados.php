...
<html>
<head>
<title>Listado de Grados Academicos</title>
...
function paginar(f)
{	
	location.href="navegador_grados.php?pagina="+f.pagina.value;
...
{	
	...
	else
	{
		...
		{
			window.location="editar_grado.php?cod_grado="+cod_registro;
		}
	}
}
...
function eliminar(f)
{
	...
	{
			window.location ="lista_eliminar_grados.php?datos="+datos;			
	}
}
</script>
...
02 de Julio de 2008
-->
<form name="form1" method="post" action="registrar_grado.php" >
<?php 
	require("conexion.inc");
	include("funciones.php");

?>
<h3 align="center" style="background:white;font-size: 14px;color: #d20000;font-weight:bold;">Listado de Grados Academicos </h3>
...
<?php	
		...
		$sql=" select cod_grado, nombre_grado, abrev_grado, cod_estado_registro ";
		$sql.=" from grados order by nombre_grado asc  ";
