...
<script language='Javascript'>
	...
	function cancelar(f){
					window.location="navegadorCargos.php";
	}
</script>
...
02 de Julio de 2008
-->
<form name="form1" method="post" action="eliminarCargos.php">
<?php 
...
<input type="hidden" name="datos" value="<?php echo $datos; ?>">
	<h3 align="center" style="background:white;font-size: 14px;color: #d20000;font-weight:bold;">Confirmacion de Eliminacion de Cargos </h3>
