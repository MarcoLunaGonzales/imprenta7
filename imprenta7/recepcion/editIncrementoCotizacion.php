...
<!---Autor:Gabriela Quelali Siñani
	02 de Julio de 2008
-->
<form   method="post" action="saveEditIncrementoCotizacion.php" name="form1">
		...
		<tr bgcolor="#FFFFFF">
		 ...
		 <tr bgcolor="#FFFFFF">
     		<td>Monto de Incremento </td>
      		<td>
			<input type="text" name="incremento_cotizacion" id="incremento_cotizacion" value="<?php echo $incremento_cotizacion; ?>" class="textoform"></td>
    	</tr>      
		 <tr bgcolor="#FFFFFF">
