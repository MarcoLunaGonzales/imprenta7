...
<table border="0" width="100%" id="dataCarac<?php echo $fila?>">
	...
	while($dat2=mysql_fetch_array($resp2)){
			...
			<?php
			$sql3="SELECT cc.COD_CARAC,c.desc_carac FROM componentes_caracteristica cc, caracteristicas c WHERE  cc.COD_CARAC=c.COD_CARAC and COD_COMPITEM='".$codCompItem."' ORDER BY cc.COD_CARAC ASC";
