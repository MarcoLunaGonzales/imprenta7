...
resultados_ajax('searchRptProveedores.php?nombreProveedorB='+document.form1.nombreProveedorB.value);

}
function paginar(f)
{		
		location.href='rptProveedores.php?nombreProveedorB='+document.form1.nombreProveedorB.value+'&pagina='+document.form1.pagina.value;	
}
...
<body bgcolor="#F7F5F3">
<form name="form1" method="post"  action="../reportes/pdfProveedores.php" target="_blank" id="form1">
<?php
...
?>
<h3 align="center" style="background:#F7F5F3;font-size: 14px;color: #E78611;font-weight:bold;">LISTADO DE PROVEEDORES </h3>

<table border="0" align="center" width="60%">
<tr align="center">
<td colspan="5"><strong>Proveedor</strong>
  <input name="nombreProveedorB" id="nombreProveedorB" size="30" class="textoform" value="<?php echo $nombreProveedorB; ?>" onkeyup="buscar()">
	</td>
</tr>
...
?>
	<table width="90%" align="center" cellpadding="1" cellspacing="1" bgColor="#cccccc">
		...
		<tr><th colspan="12" class="fila_par" align="center">&iexcl;No existen Registros!</th></tr>
	</table>
