...
function abrirVentana(){
	...
	//window.open('rptCuentasCobrar.php?fecha='+document.form1.fecha.value+'&cod_cliente='+document.form1.cod_cliente.value,'ESTADO DE CUENTAS POR COBRAR','top=50,left=200,width=800,height=600,scrollbars=1,resizable=1');
